...
from game.starter_loadout import StarterLoadout, sync_starter_loadout
...
def build_character(
    ...
    *,
    ...
    starter_loadout: StarterLoadout | None = None,
) -> Character:
    ...
    if starter_loadout is not None:
        sync_starter_loadout(character, starter_loadout)
    elif starter_skills:
