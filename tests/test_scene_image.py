...
from chain.scene_image import _build_prompt, generate_scene_image
...
def test_generate_uses_seedream(mock_seedream, mock_settings):
    ...
    mock_seedream.return_value = "https://example.com/img.png"

    url = generate_scene_image("场景", "世界", "基调")
...
def test_seedream_api_call(mock_settings, mock_client_cls):
    ...
    url = _generate_seedream("测试 prompt", settings)
    assert url == "https://img.test/1.jpg"
